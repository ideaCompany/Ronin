...
jQuery(function($) {
	...
	/* IMPORTANT SKILL  Slider, rest can go after fin */
	$("#skills .slider-items").owlCarousel({
		items: 1, //1 items above 1000px browser width
		itemsDesktop: [1024, 1], //1 items between 1024px and 901px
		itemsDesktopSmall: [900, 1], // 1 items betweem 900px and 601px
		itemsTablet: [640, 1], //1 items between 600 and 0;
		itemsMobile: [480, 1],
		navigation: false,
	...
	$("#skill_slider .slider-items").owlCarousel({
		items: 1, //1 items above 1000px browser width
		itemsDesktop: [1024, 4], //5 items between 1024px and 901px
		itemsDesktopSmall: [900, 3], // 3 items betweem 900px and 601px
		itemsTablet: [640, 2], //2 items between 600 and 0;
